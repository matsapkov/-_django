...
def index(request):
    ...
    html = f"<h1>Страница приложения tasks</h1><a href='{quality_control_url}'>Перейти на главную страницу приложения quality_control</a><br><a href='{projects_list_url}'>Список проектов</a>"
